          ...
          <div className="main">
            <div className="title-out">
              ...
              <Flex
                ...
                align="center"
              >
                <div className="title" style={{ color: "rgb(247, 231, 206)" }}>
                  PRAVEENKUMAR K
                </div>
                <div
                  className="sub-title"
                  style={{ color: "rgb(247, 231, 206)" }}
                >
                  FRONTEND DEVELOPER
                </div>
              </Flex>
            ...
            <div className="object-out">
              ...
              <div className="object">
                Seeking a challenging role in a reputable organization to
                utilize my technical, database, and management skills for the
                growth of the organization as well as to enhance my knowledge
            ...
            <div className="object-out">
              ...
              <div className="edu">
                ...
                <div className="work-contant">
                  <li>
                    Develop Web Application by using Codeigniter framework.
                  </li>
                  <li>
            ...
            <div className="object-out">
              ...
              <div className="edu">
                ...
                <div className="work-contant">
                  <li>
                    And my final year project was done in web development by
                    using MEAN stack.
                  </li>
                  <li>
                    The main aim of this project is to handle these resources
                    efficiently in such a way that both the staff and Students
                    get satisfied with a hassle free experience.
                  </li>
                  <li>
                    The proposed project does this by generating college
                    Preferred Modules Like Departments and Corresponding
                    Managements and also deploying roles to handle them and
                    maintain hierarchy and reduce management conflicts. ( Kind
                    of college management by using Secure Authorization Token)
                  </li>
                </div>
              </div>
              <div className="object-out">
